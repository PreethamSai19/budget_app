...
// Function Constructor(Private Function)
    ...
    var DOMstrings = {
       ...
       var formatNumber = function(num, type) {
           ...
           numSplit = num.split('.');
            ...
            int = numSplit[0];
            if(int.length > 3) {
                int = int.substr(0, int.length - 3) + ',' + int.substr(int.length - 3, int.length);  // input 2310,  outpu 2,310
            }
...
var controller = (function(budgetCtrl, UICtrl) {   
    ...
    var ctrlDeleteItem = function(event) {
        ...
        if (itemID) {
            ...
            // 4. Calculate and update the Percenatages 
